...
//       {/* Main Container - Centered with Features */}
//       <div
...
//           <div className="relative">
//             {/* Features Grid positioned around center */}
...
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[0].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[0].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[0].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[0].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[0].active && (
...
//                   <div className="flex items-center space-x-3">
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[3].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[3].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[3].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[3].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[3].active && (
//                     <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
//                   )}
//                 </div>
//               </div>

//               {/* Empty cell for center temperature control */}
//               <div></div>
...
//                   <div className="flex items-center space-x-3">
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[1].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[1].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[1].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[1].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[1].active && (
//                     <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
//                   )}
//                 </div>
//               </div>
...
//                           setTargetTemp((prev) => Math.max(15, prev - 0.5))
//                         }
//                         className="p-2 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:scale-110 transition-transform shadow-lg"
//                       >
...
//                           setTargetTemp((prev) => Math.min(30, prev + 0.5))
//                         }
//                         className="p-2 rounded-full bg-gradient-to-r from-red-500 to-orange-500 text-white hover:scale-110 transition-transform shadow-lg"
//                       >
...
//                         <p className="text-white/70 text-xs">Efficiency</p>
//                         <p className="text-white font-medium text-xs">94%</p>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <div className="flex items-center space-x-3">
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[4].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[4].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[4].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[4].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[4].active && (
//                     <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
//                   )}
//                 </div>
//               </div>
...
//                   <div className="flex items-center space-x-3">
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[2].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[2].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[2].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[2].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[2].active && (
//                     <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
//                   )}
//                 </div>
//               </div>
...
//                   <div className="flex items-center space-x-3">
//                     <div
//                       className={`p-2 rounded-xl bg-gradient-to-r ${smartFeatures[5].color} text-white shadow-lg`}
//                     >
//                       {smartFeatures[5].icon}
//                     </div>
//                     <div>
//                       <h3 className="text-white font-medium text-sm">
//                         {smartFeatures[5].name}
//                       </h3>
//                       <p className="text-white/70 text-xs">
//                         {smartFeatures[5].value}
//                       </p>
//                     </div>
//                   </div>
//                   {smartFeatures[5].active && (
//                     <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
//                   )}
//                 </div>
//               </div>
...
//       {/* Info Panel */}
//       <div
//         className={`absolute bottom-6 left-1/2 -translate-x-1/2 max-w-md transition-all duration-300 w-[90vw] min-h-32 flex justify-center ${
//           isPanelOpen
//             ? "opacity-100 translate-y-0"
//             : "opacity-0 translate-y-4 pointer-events-none"
//         }`}
...
//           <button
//             onClick={() => setIsPanelOpen(!isPanelOpen)}
//             className={`relative w-20 h-10 rounded-full transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400/50 hover:scale-105 ${
//               isPanelOpen
